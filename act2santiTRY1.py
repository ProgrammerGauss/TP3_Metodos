...
# Función para cargar imágenes desde un archivo zip y devolverlas como una matriz
...
# Cargar las imágenes de los archivos zip
dataset1_path = 'datasets_imgs.zip'
dataset2_path = 'datasets_imgs_02.zip'
X1, img_shape = load_images_from_zip(dataset1_path)
X2, _ = load_images_from_zip(dataset2_path)
...
def plot_reconstructed_images(X, svd, img_shape, d_values):
    ...
    for i, d in enumerate(d_values):
        X_approx = svd.inverse_transform(X[:, :d])
